...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x3597263e43bf58da, ; from name: libLiteCore
		i64 u0x7d6cf5af71d22967, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x65b14e0f18d11395, ; from name: LiteCore.so
		i64 u0x7d6cf5af71d22967, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7d6cf5af71d22967, ; from name: libLiteCore.so
		i64 u0x7d6cf5af71d22967, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb900bc62f4e5a7a1, ; from name: LiteCore
		i64 u0x7d6cf5af71d22967, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libLiteCore.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.couchbasetodo\00", align 16

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [15 x i8] c"libLiteCore.so\00", align 1
